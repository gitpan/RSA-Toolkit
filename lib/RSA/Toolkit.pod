...
There are 3 options for this mothed, which are C<field>, C<type>, and C<value>. To filter 
the users with conditions, you need to issue the correct combination of these 3 options.
